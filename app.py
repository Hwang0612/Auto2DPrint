...
from printplan_ai.utils.visualizer_3d import (
    build_3d_toolpath_webgl,   # ← NEW: Three.js realistic renderer
    build_3d_toolpath_fig,     # ← kept for Wireframe fallback only
    build_layer_2d_fig,
...
with tab_3d:
    ...
    # ── 3D Render decision ───────────────────────────────────────
    # • "Extruded Concrete Beads" → Three.js WebGL (realistic volumetric beads)
    # • "Wireframe Toolpath"      → Plotly fallback  (fast line preview)
    if render_mode == "Extruded Concrete Beads":
        ...
        # Wireframe: use legacy Plotly (fast, no geometry overhead)
...
# ═══════════════════════════════════════════════════════════════════
# TAB 5 — Technical Specs & Architecture
# ═══════════════════════════════════════════════════════════════════
with tab_docs:
